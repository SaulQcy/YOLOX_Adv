...
class Exp(BaseExp):
    ...
    def get_adv_trainer(self, args):
        from yolox.core.adv_trainer import Adv_Trainer
        trainer = Adv_Trainer(self, args)
        # NOTE: trainer shouldn't be an attribute of exp object
        return trainer
    
    # Free-Adv and its Baseline.
    def get_free_adv_trainer(self, args):
        from yolox.core.adv_trainer import Free_Adv_Trainer
    ...
    def get_baseline_free_adv_trainer(self, args):
        ...
        # NOTE: trainer shouldn't be an attribute of exp object
        return trainer
    def get_mix_free_adv_trainer(self, args):
        from yolox.core.adv_trainer import Mix_Free_Adv_Trainer
